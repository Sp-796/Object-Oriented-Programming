...
This repository contains a collection of Object-Oriented Programming (OOP) exercises in Java focused on core principles like inheritance, polymorphism, encapsulation, and abstraction. 
The source code is organized inside the src/ directory, modeling practical systems such as characters, attributes, and roles. 
A class diagram is included to illustrate the structural relationships, method behaviors, and inheritance hierarchies.
